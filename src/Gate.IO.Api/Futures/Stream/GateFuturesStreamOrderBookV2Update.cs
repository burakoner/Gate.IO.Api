...
/// <summary>
/// Represents a Futures order book V2 update notification.
/// </summary>
public class GateFuturesStreamOrderBookV2Update
{
    /// <summary>
    ...
    public List<GateFuturesStreamOrderBookV2Entry> Bids { get; set; } = [];

    /// <summary>
    /// Ask updates since the previous update.
    /// </summary>
    [JsonProperty("a", NullValueHandling = NullValueHandling.Ignore)]
    public List<GateFuturesStreamOrderBookV2Entry> Asks { get; set; } = [];
}
