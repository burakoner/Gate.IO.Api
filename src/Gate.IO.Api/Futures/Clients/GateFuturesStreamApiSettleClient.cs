...
/// </summary>
public class GateFuturesStreamApiSettleClient
{
    internal GateFuturesSettlement Settlement { get; }
    internal GateFuturesStreamApiClient MainClient { get; }

    internal GateFuturesStreamApiSettleClient(GateFuturesStreamApiClient main, GateFuturesSettlement settle)
    {
        MainClient = main;
        Settlement = settle;
    }
    ...
    */
    ...
    /// <summary>
    /// Executes the Subscribe To Index Price Candlesticks operation.
    /// </summary>
    ...
    /// <summary>
    /// Executes the Subscribe To User Deleverages operation.
    /// </summary>
    ...
    /// <summary>
    /// Executes the Subscribe To User Reduce Risk Limits operation.
    /// </summary>
