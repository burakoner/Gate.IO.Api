namespace Io.Gate.GateApi.Model
{
    ...
    public class RepayRequest :  IEquatable<RepayRequest>
    {
        /// <summary>
        /// Repay mode. all - repay all; - repay only some portion
        /// </summary>
        /// <value>Repay mode. all - repay all; - repay only some portion</value>
        ...
        /// <param name="mode">Repay mode. all - repay all; - repay only some portion (required).</param>
