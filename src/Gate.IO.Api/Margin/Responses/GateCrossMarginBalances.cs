...
/// </summary>
public record GateCrossMarginBalances
{
    /// <summary>
    /// User ID
    /// </summary>
    ...
    public Dictionary<string, GateCrossMarginBalance> Balances { get; set; }
