...
public class GateMarginRestApiClient
{
    ...
    private const string fundingAccountsEndpoint = "funding_accounts";
    ...
    public Task<RestCallResult<List<GateMarginBalance>>> GetBalancesAsync(string symbol = null, CancellationToken ct = default)
    {
        ...
        return _.SendRequestInternal<List<GateMarginBalance>>(_.GetUrl(api, v4, margin, accountsEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        return _.SendRequestInternal<List<GateMarginBalanceHistory>>(_.GetUrl(api, v4, margin, accountBookEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters);
    }
        ...
        CancellationToken ct = default)
    {
        ...
        return _.SendRequestInternal<List<GateMarginFundingBalance>>(_.GetUrl(api, v4, margin, fundingAccountsEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters);
    }
    ...
    public Task<RestCallResult<GateMarginAutoRepayment>> SetAutoRepaymentAsync(GateMarginAutoRepaymentStatus status, CancellationToken ct = default)
    {
        ...
        return _.SendRequestInternal<GateMarginAutoRepayment>(_.GetUrl(api, v4, margin, autoRepayEndpoint), HttpMethod.Post, ct, true, bodyParameters: parameters);
    }
    ...
    {
        return _.SendRequestInternal<GateMarginAutoRepayment>(_.GetUrl(api, v4, margin, autoRepayEndpoint), HttpMethod.Get, ct, true);
    }
    ...
    public Task<RestCallResult<GateMarginAmount>> GetTransferableAmountAsync(string currency, string symbol = null, CancellationToken ct = default)
    {
        ...
        return _.SendRequestInternal<GateMarginAmount>(_.GetUrl(api, v4, margin, transferableEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters);
    }
