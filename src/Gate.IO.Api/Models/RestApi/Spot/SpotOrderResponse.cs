...
/// Spot order details
/// </summary>
public  class SpotOrderResponse: SpotOrderRequest
{
    /// <summary>
    /// Order ID
    /// </summary>
    ...
    public decimal? GtTakerFee { get; private set; }
    ...
    public decimal RebatedFee { get; private set; }

    /// <summary>
    /// Rebated fee currency unit
    /// </summary>
    [JsonProperty("rebated_fee_currency")]
    public decimal RebatedFeeCurrency { get; private set; }
}

public class BatchOrderResponse : SpotOrderResponse
{
...
public class OpenOrders
{
    ...
    [JsonProperty("orders")]
    public IEnumerable<SpotOrderResponse> Orders { get; set; } = new List<SpotOrderResponse>();
}