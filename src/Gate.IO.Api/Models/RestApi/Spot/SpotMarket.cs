...
public  class SpotMarket
{
    ...
    /// Trading Status
    /// </summary>
    [JsonProperty("trade_status"), JsonConverter(typeof(SpotMarketStatusConverter))]
    public SpotMarketStatus Status { get; set; }

    /// <summary>
    /// Sell start unix timestamp in seconds
    /// </summary>
    [JsonProperty("sell_start"), JsonConverter(typeof(DateTimeConverter))]
    public DateTime SellStart { get; set; }

    /// <summary>
    /// Buy start unix timestamp in seconds
    /// </summary>
    [JsonProperty("buy_start"), JsonConverter(typeof(DateTimeConverter))]
