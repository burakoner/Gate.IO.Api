...
public class MarginCrossRestApiClient : RestApiClient
{
    // Api
    ...
    internal MarginCrossRestApiClient(GateRestApiClient root) : base("Gate.IO CrossMargin RestApi", root.ClientOptions)
    {
        RootClient = root;
