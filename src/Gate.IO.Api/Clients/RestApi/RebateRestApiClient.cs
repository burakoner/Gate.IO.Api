...
public class RebateRestApiClient : RestApiClient
{
    // Api
    protected const string api = "api";
    protected const string version = "4";
    protected const string rebate = "rebate/agency";

    // Endpoints
    private const string transactionHistoryEndpoint = "transaction_history";
    private const string commissionHistoryEndpoint = "commission_history";
    ...
    internal RebateRestApiClient(GateRestApiClient root) : base("Gate.IO Rebate RestApi", root.ClientOptions)
    {
        RootClient = root;
