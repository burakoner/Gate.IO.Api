...
public class FuturesDeliverySettleRestApiClient
{
    internal FuturesDeliveryRestApiClient MainClient { get; }
    internal FuturesDeliverySettle Settlement { get; }

    internal FuturesDeliverySettleRestApiClient(FuturesDeliveryRestApiClient main, FuturesDeliverySettle settle)
    {
        MainClient = main;
        Settlement = settle;
    }
