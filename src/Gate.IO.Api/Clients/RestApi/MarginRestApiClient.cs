...
public class MarginRestApiClient : RestApiClient
{
    // Api
    ...
    internal MarginRestApiClient(GateRestApiClient root) : base("Gate.IO Margin RestApi", root.ClientOptions)
    {
        RootClient = root;
    ...
    public async Task<RestCallResult<IEnumerable<MarginFundingBook>>> GetFundingBookAsync(string currency, CancellationToken ct = default)
    {
        ...
        return await SendRequestInternal<IEnumerable<MarginFundingBook>>(RootClient.GetUrl(api, version, margin, fundingBookEndpoint), HttpMethod.Get, ct, false, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Margin account list
    public async Task<RestCallResult<IEnumerable<MarginBalance>>> GetBalancesAsync(string symbol = "", CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object>();
        parameters.AddOptionalParameter("currency_pair", symbol);

        return await SendRequestInternal<IEnumerable<MarginBalance>>(RootClient.GetUrl(api, version, margin, accountsEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region List margin account balance change history
    public async Task<RestCallResult<IEnumerable<MarginBalanceHistory>>> GetBalancesHistoryAsync(string currency, string symbol, DateTime from, DateTime to, int page = 1, int limit = 100, CancellationToken ct = default)
    ...
    public async Task<RestCallResult<IEnumerable<MarginBalanceHistory>>> GetBalancesHistoryAsync(string currency = "", string symbol = "", long? from = null, long? to = null, int page = 1, int limit = 100, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object>
        {
            { "limit", limit },
        ...
        return await SendRequestInternal<IEnumerable<MarginBalanceHistory>>(RootClient.GetUrl(api, version, margin, accountBookEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Funding account list
    public async Task<RestCallResult<IEnumerable<MarginFundingBalance>>> GetFundingBalancesAsync(string currency = "", CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object>();
        parameters.AddOptionalParameter("currency", currency);

        return await SendRequestInternal<IEnumerable<MarginFundingBalance>>(RootClient.GetUrl(api, version, margin, accountsEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Lend or borrow
    public async Task<RestCallResult<LoanResponse>> LoanAsync(
        MarginLoanSide side,
        string currency,
        decimal amount,
        decimal? rate = null,
        ...
        => await LoanAsync(new LoanRequest
        {
            Side = side,
            Currency = currency,
            Symbol = symbol,
    ...
    public async Task<RestCallResult<LoanResponse>> LoanAsync(LoanRequest request, CancellationToken ct = default)
    {
        ...
        return await SendRequestInternal<LoanResponse>(RootClient.GetUrl(api, version, margin, loansEndpoint), HttpMethod.Post, ct, true, bodyParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region List all loans
    public async Task<RestCallResult<IEnumerable<LoanResponse>>> GetLoansAsync(
        MarginLoanSide side,
        ...
        CancellationToken ct = default)
    {
        ...
        return await SendRequestInternal<IEnumerable<LoanResponse>>(RootClient.GetUrl(api, version, margin, loansEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Merge multiple lending loans
    public async Task<RestCallResult<LoanResponse>> MergeLoansAsync(string currency, IEnumerable<long> ids, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object> {
            { "currency", currency },
            { "ids", string.Join(",", ids) }
        ...
        return await SendRequestInternal<LoanResponse>(RootClient.GetUrl(api, version, margin, mergedLoansEndpoint), HttpMethod.Post, ct, true, bodyParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Retrieve one single loan detail
    public async Task<RestCallResult<LoanResponse>> GetLoanAsync(MarginLoanSide side, long loanId, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object> {
            { "side", JsonConvert.SerializeObject(side, new MarginLoanSideConverter(false)) },
        };

        return await SendRequestInternal<LoanResponse>(RootClient.GetUrl(api, version, margin, loansEndpoint.AppendPath(loanId.ToString())), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Modify a loan
#if NETSTANDARD2_1
    public async Task<RestCallResult<LoanResponse>> ModifyLoanAsync(
        int loanId,
        string currency,
        MarginLoanSide side,
        bool autoRenew,
        ...
        CancellationToken ct = default)
    {
        ...
        return await SendRequestInternal<LoanResponse>(RootClient.GetUrl(api, version, margin, loansEndpoint.AppendPath(loanId.ToString())), HttpMethod.Patch, ct, true, bodyParameters: parameters).ConfigureAwait(false);
    }
#endif
    #endregion

    #region Cancel lending loan
    public async Task<RestCallResult<LoanResponse>> CancelLendingLoanAsync(long loanId, string currency, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object> {
            { "currency", currency },
        };

        return await SendRequestInternal<LoanResponse>(RootClient.GetUrl(api, version, margin, loansEndpoint.AppendPath(loanId.ToString())), HttpMethod.Delete, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Repay a loan
    public async Task<RestCallResult<LoanResponse>> RepayLoanAsync(long loanId, string currency, string symbol, MarginLoanRepayMode mode, decimal? amount = null, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object> {
            { "currency", currency },
        ...
        return await SendRequestInternal<LoanResponse>(RootClient.GetUrl(api, version, margin, loansEndpoint.AppendPath(loanId.ToString()).AppendPath("repayment")), HttpMethod.Post, ct, true, bodyParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region List loan repayment records
    public async Task<RestCallResult<IEnumerable<LoanRepayment>>> GetLoanRepaymentsAsync(long loanId, CancellationToken ct = default)
    {
        return await SendRequestInternal<IEnumerable<LoanRepayment>>(RootClient.GetUrl(api, version, margin, loansEndpoint.AppendPath(loanId.ToString()).AppendPath("repayment")), HttpMethod.Get, ct, true).ConfigureAwait(false);
    }
    #endregion

    #region List repayment records of a specific loan
    public async Task<RestCallResult<IEnumerable<LoanRecord>>> GetLoanRecordsAsync(long loanId, MarginLoanStatus? status = null, int page = 1, int limit = 100, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object> {
            { "loan_id", loanId },
            { "page", page },
        ...
        return await SendRequestInternal<IEnumerable<LoanRecord>>(RootClient.GetUrl(api, version, margin, loanRecordsEndpoint), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Get one single loan record
    public async Task<RestCallResult<LoanRecord>> GetLoanRecordAsync(long loanId, long loanRecordId, CancellationToken ct = default)
    {
        var parameters = new Dictionary<string, object> {
            { "loan_id", loanId },
        };

        return await SendRequestInternal<LoanRecord>(RootClient.GetUrl(api, version, margin, loanRecordsEndpoint.AppendPath(loanRecordId.ToString())), HttpMethod.Get, ct, true, queryParameters: parameters).ConfigureAwait(false);
    }
    #endregion

    #region Modify a loan record
#if NETSTANDARD2_1
    public async Task<RestCallResult<LoanRecord>> ModifyLoanRecordAsync(
        int loanId,
        long loanRecordId,
        string currency,
        MarginLoanSide side,
        ...
        CancellationToken ct = default)
    {
        ...
        return await SendRequestInternal<LoanRecord>(RootClient.GetUrl(api, version, margin, loanRecordsEndpoint.AppendPath(loanRecordId.ToString())), HttpMethod.Patch, ct, true, bodyParameters: parameters).ConfigureAwait(false);
    }
#endif
    #endregion
