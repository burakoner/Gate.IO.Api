...
public class FuturesDeliveryRestApiClient : RestApiClient
{
    // Api
    ...
    // Public Clients
    public FuturesDeliverySettleRestApiClient BTC { get; }
    public FuturesDeliverySettleRestApiClient USDT { get; }

    internal FuturesDeliveryRestApiClient(GateRestApiClient root) : base("Gate.IO Delivery Futures RestApi", root.ClientOptions)
    {
        RootClient = root;
        ...
        this.BTC = new FuturesDeliverySettleRestApiClient(this, FuturesDeliverySettle.BTC);
        this.USDT = new FuturesDeliverySettleRestApiClient(this, FuturesDeliverySettle.USDT);
    }
