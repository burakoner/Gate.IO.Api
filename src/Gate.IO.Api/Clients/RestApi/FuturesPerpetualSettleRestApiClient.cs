...
public class FuturesPerpetualSettleRestApiClient
{
    internal FuturesPerpetualRestApiClient MainClient { get; }
    internal FuturesPerpetualSettle Settlement { get; }

    internal FuturesPerpetualSettleRestApiClient(FuturesPerpetualRestApiClient main, FuturesPerpetualSettle settle)
    {
        MainClient = main;
        Settlement = settle;
    }
